	...
	<header class="body-header logged">
		...
		<div id="header-up" class="container">
			<ul class="top-menu">
				<li>
					<a class="" href="?src=S02-tarjetas.php">
						<span class="icon-16 blue f15-favoritos"></span>
						<span class="d02-atencionalcliente-text">Mis puntos 
							<strong>1.500</strong>
						</span>
					</a>
				</li>
				<li class="ejecutivo-btn">
					...
					<a class="showhide-trigger" href="#top-menu-atencion-ejecutivo">
						<span class="icon-16 blue d02-atencionalcliente"></span>
						<span class="d02-atencionalcliente-text">Mi ejecutivo 
							<strong>Ana María Olea</strong>
						</span>
					</a>
					<!-- atencion cliente -->
						...
						<ul>
							...
							<li>
								<a href="https://www.google.es/maps/place/Bbva/@-33.4245607,-70.6119668,17z/data=!3m1!4b1!4m2!3m1!1s0x9662cf65c7687337:0xe8bd98d4bc5ad3fb" target="_blank">
									<span class="icon-24 blue a01-nuestrobanco"></span>
										Oficina BBVA 0123 
									<small>Via de la Ilustración 23</small>
								</a>
							</li>
						</ul>
					</div>
				...
				<li>
					...
					<div id="top-menu-atencion-cliente" class="hidden info-box">
						...
						<ul>
							...
							<li>
								<a href="includes/components/movements/tarjetas/dialogs/apagar-tarjeta.html" class="text-info cursor modal-trigger">
								<span class="apagarEcender"></span>
									On / Off Tarjetas
								</a>
							</li>
							<li>
							...
							<li>
								<a href="includes/components/dialogs/anular-cheque-modal-pre.html" class="text-info modal-trigger re-modal pointer" target="_blank">
								<span class="icon-24 blue b12-cheque"></span>
								Bloquear cheques
								</a>
							</li>
							<li>
							...
							<li>
								<a href="?src=S02-cierre-de-productos.php" class="text-info">
								<span class="icon-24 blue n05-eliminar"></span>
									Cierre de Productos
								</a>
							</li>
							...
							<li class="gray"><a href="#"><span class="icon-24 gray d03-chat pull-left"></span><strong>Chat BBVA</strong></a></li>
							<li class="gray"><a href="#"><span style="background-position: -74px -740px;" class="icon-24 gray d03-conoce pull-left"></span><strong>Conoce tu Sitio</strong></a></li>
						</ul>
					</div>
				</li>
			...
			<div class="main-menu">
				...
				<ul id="personas-submenu" class="sub-menu active">
					...
					<li class="<?php echo ($current == 'tarjetas' ? 'active': ''); ?>">
						<a href="?src=S02-tarjetas.php">Tarjetas</a>
					</li>
					<li class="<?php echo ($current == 'creditos' ? 'active': ''); ?>">
						<a href="?src=S07-creditos.php">Créditos</a>
					</li>
					...
					<li class="<?php echo ($current == 'seguros' ? 'active': ''); ?>">
						<a href="?src=S02-seguros.php">Seguros</a>
					</li>
					<li class="<?php echo ($current == 'cloud' ? 'active': ''); ?>">
						<a href="?src=S20-cloud-contact.php">BBVA Cloud</a>
					</li>
					...
					<li class="ofertas">
						<a href="?src=S17-ofertas-un-click.php">Mis Ofertas</a>
						<span class="alerta-oferta">4</span>
					</li>
