...
<div id="operacion-consulta">
	<header>
		<div class="operation-header hidden-xs">
			...
			<div class="row">
				<div class="col-md-8"><h3 class="tab-title">
					<button class="btn arrow-left primary quiero close-operation" type="button">Quiero</button> Ver movimientos históricos</h3></div>
				<div class="col-md-4">
		...
		<div class="operation-header visible-xs">
			<a class="close-operation-tab" href="#"><span class="close-icon"></span></a>
			<h3 class="tab-title">Ver movimientos históricos</h3>
		</div>
	</header>
	...
	<div class="operation-body">
		<div class="operation-body-inter">
			...
			<div class="table-footer-inter">
				<?php include '../table-interior-consultar-movimiento-historico.html'; ?>
