...
<div class="anular">
	<div id="anular-view-1" class="anular-view">
		<div class="anular-content">
			<h3 class="show">Anular ingreso</h3>
			<p class="block-warning iconed-24"><span class="icon-24  d05-ayudaurgente"></span>Vas a anular el ingreso en cuenta de ahorro periódica de $ <strong>“xxxx”</strong> cada <strong>“xxx”</strong> meses a la cuenta de <strong>“xxxxxxxxxxxx”</strong> </p>	
		</div>
		<div class="footer-anular">
			<hr class="visible-xs">
			<div class="button-bar clearfix">
				<button id="anular-back-btn-1" class="btn arrow-left prev pull-left show-operation" data-href="includes/components/movements/ahorro-movimientos/operations/gest-operaciones.php" type="button">Anterior</button>
		...
		<div class="comprobante">
			<div class="ok-layer">
				...
				<div class="ok-content">
					<div class="title">Ingreso anulado correctamente</div>
			...
			<hr class="hidden-xs">
			<div class="botonesComprobante hidden-xs">	
				<button class="btn primary left" type="button"><i class="icon-32 blue n01-imprimir"></i> Imprimir comprobante</button>
				...
				<button class="btn primary right" type="button"><i class="icon-32 blue c01-transferencias"></i> Realizar otra transferencia</button>
			</div>
		</div>
		<div class="footer-anular">
			<hr class="visible-xs">
			<div class="button-bar clearfix">
				<button id="anular-close-btn" class="btn pull-right show-operation" data-href="includes/components/movements/ahorro-movimientos/operations/gest-operaciones.php">Cerrar</button>
			</div>	
		</div>	
	</div>
</div>
