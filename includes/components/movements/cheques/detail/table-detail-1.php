	...
	<div class="table-detail-border">
		<header>
			...
			<table class="detail">
				<tbody>
					<tr>
						<td><a href="#">00000000542</a></td>
						<td>10/12/2013</td>
						<td>PAGADO AUTOMAT.</td>
						<td><em>$ - 312.200</em></td>
						<td class="xs-view">
							<div class="left">
								<a href="#">00000000542</a>
								<small>10/12/2013</small>
							</div>
							<div class="right">
								<em>- 140.200</em>
								<small>PAGADO AUTOMAT.</small>
							</div>
						</td>
					</tr>
				</tbody>
		...
		<footer class="hidden-xs">
			...
			<div class="right">
				<?php include(realpath(dirname(__FILE__))."/../../../extra/archivos.html"); ?>	
			</div>
		</footer>
		<footer class="hidden-xs">
			<hr>
			<h2>Notas</h2>
			<div class="right">
				<?php include(realpath(dirname(__FILE__))."/../../../extra/notas.html"); ?>
			</div>
		</footer>
	</div>
</div>
