...
<div class="operation-header visible-xs">
	...
	<h3 class="tab-title">Pagar dividendo</h3>
	<hr>
</div>
		...
		<form novalidate id="" class="form-horizontal tooltip-validation transfer-filter">
			<article class="wizard">
				<div data-title="Cuenta origen">
					<?php include(dirname(__FILE__) . '/pagar-dividendo/remote-step-1-seleccion-cuenta.html'); ?>
				</div>
				<div data-title="Seleccionar dividendo">
                	<div class="cont-wizard">
					<?php include(dirname(__FILE__) . '/pagar-dividendo/remote-step-2-introducir-datos.html'); ?>
                    </div>
				</div>
				...
				<div data-title="Confirmar" class="ConfirmaPagoContenedor" data-multistep="false">
                	...
                	<div class="cont-wizard">
					<?php include(dirname(__FILE__) . '/pagar-dividendo/remote-step-3-confirmar.html'); ?>
                    </div>
				</div>
				<div data-title="Comprobante">
                	<div class="cont-wizard">
					<?php include(dirname(__FILE__) . '/pagar-dividendo/remote-step-4-comprobante.html'); ?>
                    </div>
