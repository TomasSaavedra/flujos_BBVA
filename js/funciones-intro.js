...
$(document).ready(function() {
    ...
    if ($(window).width() > 768) {
        ...
        $("#btn1").on("click",function(){
            ...
            $("#intro-dropdown").addClass("dropdown-up");
            $(".modal-interior.modal-inter1").animate({ 
                opacity: 0,
                top: "0"
                }, 300, function() {
        ...
        $("#btn2-atras").on("click",function(){
            $("#intro-dropdown").removeClass("dropdown-up");
        ...
        $("#btn2-adelante").on("click",function(){
            $("#intro-dropdown").removeClass("dropdown-up");
            $("#btn-laterales .btn-chat").addClass("chat-on");
            $(".modal-interior.modal-inter2").css("display", "none");
            $(".modal-interior.modal-inter2").animate({ 
                opacity: 0
                }, 300, function() {
        ...
        $("#btn3-atras").on("click",function(){
            $("#intro-dropdown").addClass("dropdown-up");
            $("#btn-laterales .btn-chat").removeClass("chat-on");
            $(".modal-interior.modal-inter2").css("display", "block");
            $(".modal-interior.modal-inter2").delay(300).animate({ 
                opacity: 1
                }, 300, function() {
        ...
        $('.close-icon').on('click', function(){
            $(".modal-interior, .modal-intro").css("display","none");
            $("#btn-laterales .btn-chat").removeClass("chat-on");
            $("#intro-dropdown").removeClass("dropdown-up");
            $(".modal-interior").animate({ 
                opacity: 0
                }, 300, function() {
            });
