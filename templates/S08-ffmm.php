...
<div class="container">
	...
	<div class="menu-miga">
		<p><a href="?src=S02-cuentas.php">Inicio</a> <span>Fondos Mutuos</span></p>
	</div>
	...
	<div class="section-tabs">
		...
		<!-- title -->
		<h2 class="title-sh">Fondos mutuos</h2>
		
		<!-- Section tabs  -->
		<ul class="nav nav-tabs align-center">
			<li class="active"><a href="#mis-productos">Mis productos</a></li>
			<li><a href="?src=S21-portal-inversiones.php" >Metas de Ahorro</a>
		...
		<div class="tab-content">
			<div class="tab-pane active" id="mis-productos">
				<div class="content-column" id="ahorro-inversion">
					<?php include 'includes/components/movements/ahorro-inversiones/header.html'; ?>
					<?php include 'includes/components/movements/ahorro-inversiones/tabs.html'; ?>
