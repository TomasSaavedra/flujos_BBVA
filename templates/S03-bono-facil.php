		...
		<div class="tab-content">
			<div class="tab-pane active" id="section1">
				<div class="content-column">
					<?php include 'includes/components/movements/bono-facil/header.html'; ?>
					<?php include 'includes/components/movements/bono-facil/tabs.html'; ?>
					<?php include 'includes/components/movements/bono-facil/table.html'; ?>
				</div>
