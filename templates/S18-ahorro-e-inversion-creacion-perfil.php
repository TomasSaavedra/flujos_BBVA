        ...
        <div class="section-ahorro-inversion">
                ...
                <div class="banner-column" id="ahorro-lateral"> 
                    <nav class="nav-sidebar">
                        ...
                        <a href="?src=S18-ffmm-2.php">Mis Metas</a>
                    ...
                    <aside class="links dated mini-triangled favoritas editable perfil-inversor perfil-inversor-lateral">
                        ...
                        <footer>
                            <a href="includes/components/dialogs/creacion-perfil.html" class="btn modal-trigger">Crear Perfil</a> 
                        </footer>
                    </aside>
                </div>

                <div class="content-column" id="ahorro-inversion">  
                    <?php include 'includes/components/banners/mis-productos-1.html'; ?>
                    <?php include 'includes/components/banners/mis-productos-2.html'; ?>
                    <?php include 'includes/components/banners/mis-productos-3.html'; ?>
                    <?php include 'includes/components/banners/mis-productos-4.html'; ?>
                </div>  
        </div>
    </div>
</div>
