...
.sofToken .popover.right .arrow:after {
...
<div class="container-bck " id="consumo-pre-convenio">
	<header class="m-ofertas m-ofertas__encabezada">
		<h1 class="encabezada__titulo"><strong>Tu Crédito de Consumo aprobado</strong> a un Click</h1>  
	</header>  
					...
					<div class="cont-body">  
						<table class="table-res">
							<tr>
								...
								<td class="text-left">
									<div style="text-decoration: line-through;display: inline;">1,13 %</div> 
									<strong>1,02%</strong>
									<div class="tasa-especial"><i class="icon-star-fill"></i>Tasa especial</div>
								</td>
							</tr>
							<tr>
						...
						<a href="#" data-toggle="modal" data-target=".sofToken"  class="btn btn-big2 btn-big-green"><i class="icono-btn icono-credito-verde"></i>Quiero este Crédito</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="modal-box">	
				<div class="modal-body no-bottom" id="pasoDosEditar" style="margin-bottom: 20px;">
					...
					<div class="autoriza-bbva-pass">
	                    <section class="consumo" id="modelToken">
	                        <div class="box">
	                            <div class="header">
...
<script type="text/javascript">
	...
	$('#autorizar').on('click', function(){
				window.location= '?src=S17-consumo-convenio-comprobante.php';
	});
