			...
			<div class="nav-perfil"><!--nav-perfil-->
				<button id="nav-perfil-toggle" type="button" class="show-mobile">Consultas y reclamos<span class="ico"></span></button>
					...
					<ul class="nav nav-list">
						...
						<li class="active"><span class="bg"></span><a href="content.php?src=S13-mi-perfil-consultas-reclamos.php" title=" Consultas y reclamos"> Consultas y reclamos</a></li>
					</ul>
					</nav>
			</div><!--Fin nav-perfil-->
			<?php include 'includes/components/movements/perfil/include/consultas-reclamos.html'; ?>
