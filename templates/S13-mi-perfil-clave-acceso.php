	...
	<div class="section-tabs">
		...
		<div class="container-perfil" id="perfil-datos"><!--container-perfil datos-->
			...
			<div class="nav-perfil"><!--nav-perfil-->
				<button id="nav-perfil-toggle" type="button" class="show-mobile">Clave de acceso<span class="ico"></span></button>
				<nav class="inner-nav">
					<ul class="nav nav-list">
						...
						<li class="active"><span class="bg"></span><a href="content.php?src=S13-mi-perfil-clave-acceso.php" title="Clave de acceso"> Clave de acceso</a></li>
			...
			<?php include 'includes/components/movements/perfil/include/clave-acceso.html'; ?>
