...
<div class="container">
	<div class="content">
		<head>
			...
			<link rel="stylesheet" href="http://93.16.237.242/maqueta-nueva-web/includes/components/dap/css/main.css" media="all" />
		...
		<body>
					...
					<div class="row">
			            ...
			            <div class="small-12 medium-8 large-8 columns">
		                    ...
		                    <article class="capgemini-tables holder" style="margin-top: 20px;">
									...
									<div class="row"><!-- btn -->
										<div class="button_init">
											<button class="init_button button_disable" id="dof" disabled="true">Me interesa</button>
											<!--id="next_two"-->
										</div>
									</div><!-- btn -->
			...
			<div id="enviada" style="display:none; height: auto !important; width: 80%;" class="modal modalLogin solicitudEnviada" ><!-- mensaje de solicitud enviada -->
				<h2>
			...
			<div  id="noEnviada0" style="display:none; height: auto !important" class="modal modalLogin solicitudEnviada"><!-- mensaje de solicitud enviada -->
				<h2>
			...
			<div id="noEnviada1" style="display:none; height: auto !important" class="modal solicitudEnviada"><!-- mensaje de solicitud enviada -->
			...
			<div  id="noEnviadaRegistrado" style="display:none; height: auto !important" class="modal modalLogin solicitudEnviada"><!-- mensaje de solicitud enviada -->
				<h2>
					<span class="hiddenMedium"></span> No podemos atender su solicitud</h2>
				<div class="row">
				<div class="avatar"></div>
			...
			<div id="modal-dof" style="display:none;" class="modal modalLogin">
				<div id="title_modal" class="row">
					<label>Declaración de Origen de Fondos (DOF)</label>
					<a href="#close-modal" rel="modal:close" class="close-modal ">Close</a>
				</div>
				<div class="row block_two_columns" id="dof-paso-1">
					<div class="inside-modal" style="text-align: center !important; padding: 0px 18px 18px 18px;">
						<p style="font-size: 16px">
							Para cursar Depósitos a plazo que superen los $5.000.000 al mes, es necesario que completes la Declaración de Origen de Fondos (DOF) y subirla documentación necesaria.
						</p>
						<button class="btn" id="dof-1"> Completar DOF</button>
					</div>
				</div>

				<div class="row" id="dof-paso-2" style="display: none">
					<div class="inside-modal" style="padding: 0px 18px 18px 18px;">
						<h2 class="table-title" style="border-bottom: none !important">Selecciona el Origen de los Fondos</h2>
						
						<div class="col-lg-12 pd0px">
							<div class="row">
								<div class="col-md-3 col-lg-3 col-xs-12 ">
									<label for="herencia" class="ui-marmots-label-check marmots-label-left">
								 		<input id="herencia" type="checkbox" name="herencia">Herencia
								 	</label>
								</div>
								<div class="col-md-3 col-lg-3 col-xs-12 ">
									<label for="ahorro" class="ui-marmots-label-check marmots-label-left">
								 		<input id="ahorro" type="checkbox" name="ahorro">Ahorro
								 	</label>
								</div>
								<div class="col-md-3 col-lg-3 col-xs-12 ">
									<label for="inversion" class="ui-marmots-label-check marmots-label-left">
								 		<input id="inversion" type="checkbox" name="inversion">Producto de Inversión
								 	</label>
								</div>
								<div class="col-md-3 col-lg-3 col-xs-12 ">
									<label for="bono" class="ui-marmots-label-check marmots-label-left">
								 		<input id="bono" type="checkbox" name="bono">Pago de bono
								 	</label>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-12 pd0px">
							<div class="row" style="margin-top: 10px;">
								<div class="col-md-3 col-lg-3 col-xs-12 ">
									<label for="propiedad" class="ui-marmots-label-check marmots-label-left">
								 		<input id="propiedad" type="checkbox" name="propiedad">Venta de propiedad
								 	</label>
								</div>
								<div class="col-md-3 col-lg-3 col-xs-12 ">
									<label for="automovil" class="ui-marmots-label-check marmots-label-left">
								 		<input id="automovil" type="checkbox" name="automovil">Venta automóvil
								 	</label>
								</div>
								<div class="col-md-3 col-lg-3 col-xs-12 ">
									<label for="otros" class="ui-marmots-label-check marmots-label-left">
								 		<input id="otros" type="checkbox" name="otros">Otros
								 	</label>
								</div>
								<div class="col-md-3 col-lg-3 col-xs-12 ">
						...
						<div class="col-md-12 col-lg-12 col-xs-12 pd0px">
							<label>Especifica otros</label> 
							<input type="text" id="ventasAcciones" >
						</div>

						<div class="col-md-12 col-lg-12 col-xs-12 pd0px">
							<label>¿Trabajas de forma independiente?*</label>
							<div class="large-2 small-2 medium-2 columns">
							<!-- Cambio clase de medium-6 a -3 -->
								<label class="radio_label"> 
									<div class="options">Si&nbsp;</div>
								</label> 
								<input type="radio" class="css-checkbox" name="si" value="si" id="si" checked> 
									<label for="Masculino" class="css-label radGroup1 radGroup2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</label>
							</div>
							<div class="large-2 small-2 medium-2 columns" style="float: left;">
							<!-- Cambio clase de medium-6 a -3 -->
								<label class="radio_label ">
									<div class="options">No&nbsp;</div>
								</label> 
								<input type="radio" name="no" value="no" id="no" class="css-checkbox"> 
									<label for="no" class="css-label radGroup1 radGroup2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</label>
							</div>
						</div>
...
<script type="text/javascript">		
	...
	$(function() {
		...
		$("label.ui-marmots-label-check").on('click', function(e){
			...
			if( labelSeleccionado.hasClass("on")){
					...
					$('#dof').addClass("button_disable").prop("disabled", true);
			}else {
				labelSeleccionado.addClass("on");
				labelSeleccionado.find("input").prop("checked", true);	
				$('#dof').removeClass("button_disable").prop("disabled", false);
			}
		});
	});
	...
	$(function(){
		...
		// modal DOF
		$('#dof').on('click', function(){
			$('#modal-dof').modal('fast')
		});
		$('#dof-1').on('click', function(){
			$('#dof-paso-1').hide();
			$('#dof-paso-2').fadeIn();
		});	
	});
