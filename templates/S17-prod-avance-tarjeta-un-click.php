...
<div" href="?src=S17-ofertas-un-click.php"><span class="close-icon"></span></a>
				...
				<div class="bck-inner left-cont bg-gray">
					<div class="body-bck-inner">
						<div class="form-bck form-bck-large">
							<div>
								<label for="" class="line-normal ">Tarjeta <br>Origen</label>
								...
								<small class="dato-saldo">Tu monto actual es: <strong>$15.345.344</strong></small>
						...
						<div class="form-bck">
							<div>
								<label for="" class="line-normal label-monto">Monto</label>
								<input id="monto" type="text" class="form-control number formato text-left icono-monto icono-monto-pesos text-right" autocomplete="off">
							</div>
							<div>
					    ...
					    <div class="form-bck form-bck-large">
							<div>
								<label for="" class="line-normal">Cuenta <br>Abono</label>
								<select class="selectpicker selectpicker-numeral formato">
									<option>0540-4567-3432675541</option>
									<option>0540-4567-3432675541</option>
									<option>0540-4567-3432675541</option>
								...
								<small class="dato-saldo">Tu nuevo saldo será: <strong>$15.345.344</strong></small>
				...
				<div class="bck-inner right-cont bg-blue">
					...
					<div class="datos-cargados" style="opacity:0;"><!--datos-cargados-->
						...
						<div class="header-bck-inner">
							<h4>Tu cuota será:</h4>
							<h3>$ 150.964 <span>mensuales</span></h3>
						</div>

						<div class="body-bck-inner">
							<table class="table-detail-inter">
								<tr>
									<td class="text-right">Cantidad de cuotas:</td>
									<td class="text-left"><strong>60</strong></td>
								</tr>
								<tr>
									<td class="text-right">Plazo: </td>
									<td class="text-left"><strong>8 meses</strong></td>
								</tr>
								<tr>
									<td class="text-right">Tasa mensual:</td>
									<td class="text-left">1,47%</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="text-left">$ 620.000</td>
								</tr>
							</table>
						</div>
						<hr>
						<div class="aviso-footer">
							<span class="icon-24 blue m03-aviso"></span>
							<p>Recuerda que el cupo de la Tarjeta Adicional es compartido con tu Tarjeta Titular.</p>
						</div>

						<div class="footer-bck-inner">
							<a class="link-footer modal-trigger" data-href="includes/components/movements/credito-un-click/dialogs/refinanciamiento.html">Detalles del Refinanciamiento</a>
						</div>
	    ...
	    <div class="footer-container-bck">
		    ...
		    <div class="footer-cont-btn">
			    <a href="#;" class="btn btn-big2 btn-big-green btn-big-center disabled btn-responsivo"><i class="icono-btn icono-credito-verde"></i>Quiero este avance en cuotas ahora</a>
			</div>
...
<div" href="javascript.history:back();"><span class="close-icon"></span></a>
		...
		<div class="exito-container-bck">
			...
			<h3>ya tienes tu Avance en cuotas BBVA</h3>
			...
			<div class="exito-container-bck-footer">
				<h3>El comprobante y detalle de tu Avance en cuotas fue enviado a tu e-mail  <span class="color-blue">juanmanuel@gmail.com</span></h3>
			</div>
		</div>
		...
		<div class="exito-container-bck-footer">
			<div class="footer-cont-btn">
				<a href="#;" class="btn btn-big2 btn-big-blue">Ver avance abonado en mi cuenta</a>
			</div>
