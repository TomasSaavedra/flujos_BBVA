...
<div class="container-bck container-bck-sinmenu">
	<div class="container-bck-step1">
		...
		<div class="header-container-bck">
			<h1>Tu Aumento de cupo de Línea de Crédito a un click</h1>
			<a class="close-operation-prod
<div" href="?src=S17-ofertas-un-click.php"><span class="close-icon"></span></a>
			<hr>
			<h2>Si lo deseas, puedes modificar el monto de tu nuevo cupo aprobado en pesos</strong></h2>
		...
		<div class="body-container-bck">
		    <div class="bck-inner-row">
				<div class="bck-inner left-cont bg-gray">
					<div class="body-bck-inner body-bck-inner-small">
						<div class="form-bck form-bck-max-min">
							<p class="parrafo-tit">Tu cupo actual es: $350.000</p>
							<div>
								<label class="line-normal">Nuevo <br>Cupo</label>
								<div class="cont-max-min">
									<input id="monto" type="text" class="form-control number formato text-left icono-monto icono-monto-pesos" autocomplete="off">
									<span class="min-val clear-both">máx.: <strong>$800.000</strong></span>
								</div>
							</div>
					...
					<div class="datos-cargados" style="opacity:0;"><!--datos-cargados-->
						...
						<div class="body-bck-inner">
							<table class="table-detail-inter">
								<tr>
									<td class="text-right">Cupo anterior:</td>
									<td class="text-left texto-tachado"><strong>$ 350.000</strong></td>
								</tr>
								<tr>
									<td class="text-right">Cuenta Corriente: </td>
									<td class="text-left"><strong>xxxx - 12345</strong></td>
								</tr>
							</table>
						</div>
						 <hr>
						<div class="footer-bck-inner">
							<p>Este cupo se hará efectivo al día hábil siguiente de confirmada la operación</p>
						</div>
	    ...
	    <div class="footer-container-bck">
		    ...
		    <div class="footer-cont-btn">
			    <a href="#;" class="btn btn-big2 btn-big-green btn-big-center disabled btn-responsivo"><i class="icono-btn icono-credito-verde"></i>Quiero Aumentar mi Cupo</a>
			</div>
...
<div" href="javascript.history:back();"><span class="close-icon"></span></a>
		...
		<div class="exito-container-bck">
			...
			<h3>ya tienes tu Aumento de cupo de tu Línea de Crédito</h3>
			...
			<ul class="detalle-list">
				...
				<li><span class="s-left">Nuevo cupo:</span><span>$ 800.000</span></li>
				<li><span class="s-left">Cuenta Corriente asociada:</span><span>xxxx - 12345</span></li>
				<li><span class="s-left">Línea de crédito:</span><span>xxxx - 12345 - 12345</span></li>
			</ul>
			<div class="exito-container-bck-footer">
				<h3>El comprobante y detalle de tu Aumento de cupo de tu Línea de Crédito fue enviado a tu e-mail  <span class="color-blue">juanmanuel@gmail.com</span></h3>
			</div>
		</div> 
		...
		<div class="exito-container-bck-footer">
			<div class="footer-cont-btn">
				<a href="#;" class="btn btn-big2 btn-big-blue">Ver nuevo cupo en mi línea de crédito</a>
			</div>
