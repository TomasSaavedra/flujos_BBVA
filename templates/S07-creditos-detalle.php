...
<div class="container">
	...
	<div class="menu-miga">
		<p><a href="?src=S02-cuentas.php">Inicio</a> <a href="?src=S07-creditos.php">Créditos</a> <span>Crédito 4000-4000-0123456789</span></p>
	</div>
		...
		<div class="tab-content">
			<div class="tab-pane active" id="mis-productos">
				<div class="content-column" id="creditos">
					<?php include 'includes/components/movements/creditos/header.html'; ?>
					<?php include 'includes/components/movements/creditos/tabs.html'; ?>
					<?php include 'includes/components/movements/creditos/table.html'; ?>
