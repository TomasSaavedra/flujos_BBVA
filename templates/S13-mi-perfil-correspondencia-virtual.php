...
<script type="text/javascript">
	$(document).ready(function() {
		$('.dropdown-toggle').click(function(e) {
			e.preventDefault();
			$('.dropdown-shadow').toggleClass('open');
		});

		$('.dropdown-submenu a').click(function(e) {
			e.preventDefault();
			$('.dropdown-shadow').removeClass('open');
		});
		...
		$('.check-th').click(function() {
			$(this).toggleClass('on');
			$('.ui-marmots-label-check').toggleClass('on');
		});
	});
...
<div class="container page-mi-perfil">
	<div class="section-tabs">
		...
		<div class="container-perfil corespondencia-virtual" id="perfil-datos"><!--container-perfil datos-->
			
			<div class="nav-perfil"><!--nav-perfil-->
				<button id="nav-perfil-toggle" type="button" class="show-mobile">Perfil inversor<span class="ico"></span></button>
					<nav class="inner-nav">
					<ul class="nav nav-list">
						...
						<li><span class="bg"></span><a href="content.php?src=S13-mi-perfil-notificaciones.php" title="Notificaciones y alertas"> Notificaciones y alertas</a></li>
						<li><span class="bg"></span><a href="content.php?src=S13-mi-perfil-agenda.php" title="Agenda de contactos"> Agenda de contactos</a></li>
						<li><span class="bg"></span><a href="javascript:void();" title="Perfil inversor"> Perfil inversor</a></li>
						<li><span class="bg"></span><a href="content.php?src=S13-mi-perfil-consultas-reclamos.php" title=" Consultas y reclamos"> Consultas y reclamos</a></li>
					</ul>
					</nav>
			</div><!--Fin nav-perfil-->
			<?php include 'includes/components/movements/perfil/include/correspondencia-virtual.html'; ?>
