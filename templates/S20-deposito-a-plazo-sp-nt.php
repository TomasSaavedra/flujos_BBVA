<style type="text/css">
	...
	/* ######## NT #######*/
	/* foundation2.css:1198 */
	strong.stronger {
		font-weight: bold !important;
	}

	.side_left p, .side_left li{
		font-size: 16px;
	...
	.title-container-step-one {
		padding: 40px 20px 10px;
	}

	#step_one .side_rigth_content {
		padding-bottom: 0;
	}

	#step_one .button_init {
		margin-top: 30px;
	}

	.dap-simulation-items {
		text-align: left; 
	}

	.dap-simulation-items label {
		color: #064CA4;
		font-size: 20px !important;
		font-family: 'BBVA Web light', arial !important;
		font-weight: bold;
	}

	.dap-simulation-items p {
		color: #064CA4;
		...
		<body>
			<main class="formcontent">
				...
				<section id="step_zero" class="formcontent section_main heightSection0 text_font_form">
					<div class="blocked_disabled_1" style="display: none;"></div>
		            <div class="row">
									...
									<div class="content_under">
										<div class="row">
											<div>
                                                ...
                                                <p>
													Al tomar tu Depósito a Plazo te entregamos una cuenta 
													<strong class="stronger">digital 100% online sin costo</strong> con la cual podrás:
												</p>
												<ul>
													<li>Tomar o liquidar depósitos a plazo</li>
													<li>Realizar transferencias o pago de servicios</li>
												</ul>
                                            </div>
										</div>
									</div>
							...
							<article id="side_rigth_first">
								...
								<div id="side_rigth_content">
									<div class="contentSteps1 paso1">
										<h3 class="font_lite">
											Toma tu Depósito a Plazo en tres simples pasos:
										</h3>
										<div class="row boxIcons font_lite">
											<!-- <div class="small-12 medium-2 large-2 columns hiddenMedium">&nbsp;</div> -->
											<div class="large-4 medium-4 small-12 columns">
												<!--<img src="../includes/components/dap/img/icon-producto.png">-->			
												<img src="http://93.16.237.242/maqueta-nueva-web/includes/components/dap/img/icon-producto.png">					
												<p><b>1.</b> Simula tu Depósito a Plazo</p>
											</div>
											<div class="large-4 medium-4 small-12 columns">
												<!--<img src="../includes/components/dap/img/icon-persona.png">-->		
												<img src="http://93.16.237.242/maqueta-nueva-web/includes/components/dap/img/icon-persona.png">										
												<p><b>2.</b> Ingresa tus Datos</p>
											</div>
											<div class="large-4 medium-4 small-12 columns">
												<!--<img src="../includes/components/dap/img/icon-persona.png">-->		
												<img src="http://93.16.237.242/maqueta-nueva-web/includes/components/dap/img/icon-persona.png">										
												<p><b>3.</b> Transfiere el monto simulado</p>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="button_init">
											<button class="init_button disabled" id="next_zero" disabled>Comenzar</button>
										</div>
									</div>
									<div class="text-center font_lite">
										<a id="mod-step-zero" class="modify" style="display: none;"><b>Modificar</b></a>
									</div>
								</div>
							</article>
						</div>
					...
					<div class="row">
									...
									<div class="row">
										<div class="small-11 medium-11 large-11 columns">
											<div id="head_step_one" class="head_step">
												...
												<h3>Simula tu Depósito a Plazo</h3>	
											</div>
										</div>
						...
						<div class="small-12 medium-8 large-8 columns">
							<article class="side_rigth">
								...
								<div class="side_rigth_content font_lite">
									<div class="row title-container-step-one">
										<h3 class="font_lite"><span class="nombre-solicitante">Jhon Doe</span>, ingresa el monto que deseas simular</h3>
									</div>
									<div class="row block_two_columns">
										
		                                <div class="small-12 medium-12 large-12 columns clean dap-simulation-items">
											<div class="small-6 medium-4 large-4 margin_input_form columns">
												<label>Moneda</label>
												<p>Peso</p>
											</div>
											...
											<div class="small-12 medium-4 large-4 margin_input_form columns montoSpan">
												<label>Monto</label>
												<input type="text" id="lb_monto" title="Ingresa tu Monto" data-content="" placeholder=""/>
												<span>Min. $200.000 Max. $4.700.000</span>
											</div>
										</div>
									...
									<div class="row">
										<div class="button_init">
											<button class="init_button disabled" id="next_one" disabled="true">
												Simular Depósito
											</button>
										</div>
									</div>
								</div>
								<div class="capgemini-tables holder" style="margin-top: 20px;">
		                                    ...
		                                    <div class="tables-body table-scroll">
		                                        <div>
		                                            <h2 class="table-title">
		                                            	<b>Selecciona el plazo de tu preferencia para realizar el depósito</b>
		                                            </h2>
			                                        		...
			                                        		<tr data-select-radio="true" class="blockSmall">
			                         						...
			                         						<tr class="no-hover-tr">
	                                                            <td  class="title-int-table" colspan="7">
	                                                            	<h2 class="table-title"><b>Puedes elegir el plazo que más te acomode en días</b></h2>
	                                                            </td>
		                                                    </tr>
													...
													<p class="minP30 font_lite"><strong>Mínimo 30 días</strong></p>
												</div>
		                                       </div>
		                                    </div>
		                                </div>
		                            ...
		                            <div class="terms-text">
										<label for="terminos" class="ui-marmots-label-check marmots-label-left">
									 	<input id="terminos" type="checkbox" name="terminos">Declaro haber leído y acepto los 
									 	</label><a href="#modal-terms" rel="modal:open" class="linkBottom">Terminos y condiciones</a>
										de la toma de Depósitos a Plazo
									</div>
									<div class="terms-text" style="padding-top:15px;">
										<label for="terminos" class="ui-marmots-label-check marmots-label-left">
									 	<input id="terminos" type="checkbox" name="terminos">Declaro haber leído y acepto los 
									 	</label><a href="#modal-terms" rel="modal:open" class="linkBottom">Terminos y condiciones</a>
										de contratación de la Cuenta Digital
									</div>
									<div class="row">
										<div class="button_init">
					...
					<div class="row">
						<div class="small-12 medium-4 large-4 columns">
							<article id="p1" class="side_left height_step height_step2">
								<div class="offer dap">
									...
									<div class="row">
										<div class="content_text">
											<p>Completa los datos y envía tu solicitud</p>
										</div>
									</div>
			            ...
			            <div class="small-12 medium-8 large-8 columns">
							<article class="side_rigth">
								...
								<div class="text-center title-container-step-three">
									<h3 class="font_lite">John Doe, estás a un paso de enviar tu solicitud</h3>
								</div>

								<div class="row block_two_columns small-12 large-12 medium-10 clean contentBlock">
									<div>
									...
									<div class="row">
										<div class="small-12 medium-6 large-6 column margin_input_form">
											<label>Nombre</label> 
											  <input type="text"  maxlength="9" id="lg_nameSp" title="Ingresa tu Nombre"/>
										</div>
										<div class="small-12 medium-6 large-6 column margin_input_form">
											<label>Apellido paterno</label> 
											<input type="text" id="lg_firstLastName" maxlength="" title="Ingresa tu Apellido"/>
										</div>
									</div>
									...
									<div class="row">
										<div class="small-12 medium-6 large-6 column margin_input_form">
											...
											<input type="text" id="lg_lastLastName" maxlength="" title="Ingresa tu Apellido"/>
										</div>
									...
									<div class="row">
										<div class="small-12 medium-6 large-6 column margin_input_form">
											...
											<select id="lb_career" class="select_">
												<option value="">Selecciona</option>
...
<script type="text/javascript">		
	...
	$(function(){
		...
		// sección uno
			$('#lb_name, #lb_rut').on('blur keyup', function() {
				if ($('#lb_name').val() && $('#lb_rut').val()) {
					$('#next_zero').removeClass('disabled').attr('disabled', false);
				} else {
					$('#next_zero').addClass('disabled').attr('disabled', 'disabled');
				}
			}); 

			$('#mod-step-zero').click(function() {
				$('.blocked_disabled_1 .blocked_disabled_2, .blocked_disabled').show();
				$('#step_zero .blocked_disabled_1').hide();
				$('html,body').animate({
					scrollTop : $("#step_zero").offset().top
				}, 'slow');
				$(this).hide();
			});
			...
			$("#next_zero").click(function() {
				...
				$("#step_zero").find('.blocked_disabled_1, #mod-step-zero').show();
				$("#step_one").find('.blocked_disabled').hide();
			});	
		//Fin sección uno
