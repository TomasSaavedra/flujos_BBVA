...
<div class="container">
	...
	<div class="menu-miga">
		<p><a href="?src=S02-cuentas.php">Inicio</a> <span>Acciones</span></p>
	</div>
		...
		<div class="tab-content">
			<div class="tab-pane active" id="mis-productos">
				<div class="content-column">
					<?php include 'includes/components/movements/inversiones/header.html'; ?>
					<?php include 'includes/components/movements/inversiones/tabs.html'; ?>
					<!--?php include 'includes/components/movements/inversiones/table.html'; ?-->
	...
	<!-- Informacion general -->
	<div id="informacion-catalogo">
		<div class="gray-background">
			<div class="container">
				<div id="bloqueCargaAsesor" class="aumento-cupo padding15 mHeight superior opcion1 masterWidth" style="z-index:9999;">
					...
					<button class="toRight btn abrirDos" type="button" onclick="cargaAsesorDeInversiones()">Ingresa Aquí<span class="icon-24 white f07-desplegar"></span></button>
				</div>
					...
					<div class="col-lg-12">
						...
						<div class="row">
							<div class="col-lg-4 col-sm-4">
								<div class="bbva-producto">
									<div class="contenedor-enlace">
										<h3><span class="icon-24 blue" style="background-position: 0px -1480px;">&nbsp;</span>&nbsp;&nbsp;Despósitos a Plazo</h3>
							...
							<div class="col-lg-4 col-sm-4">
								<div class="bbva-producto">
									<div class="contenedor-enlace">
										<h3><span class="icon-24 blue" style="background-position: 0px -1409px;">&nbsp;</span>&nbsp;&nbsp;Fondos Mutuos</h3>
							...
							<div class="col-lg-4 col-sm-4">
								<div class="bbva-producto">
									<div class="contenedor-enlace">
										<h3><span class="icon-24 blue" style="background-position: -75px -0px;">&nbsp;</span>&nbsp;&nbsp;Corredores de Bolsa</h3>
										...
										<a href="#" onclick="javascript: cargaIrAPortalCompraVenta();">Ingresa al Portal Aquí</a><br>
										<a href="#" onclick="javascript: cargaAbonarACuentaDeInversion();">Abonar a Cuenta Inversiones</a>				
									</div>
								</div>
							</div>
						</div>
...
<script>
	...
	<div class="page-rentabilizar">
		<div id="asesor-de-inversiones" style="display:none;" class="creditos-pago-cuentas">
	...
	<div class="main-wizard">
		<form novalidate="novalidate" id="form-asesor" class="form-horizontal tooltip-validation transfer-filter" onsubmit="return false;">
			...
			<div class="step-container" style="height: 5px; width: 900px;"><div id="wizard-slide-viewer" class="slide-viewer" style="left: 0px;"><div class="step active" style="height: 0px; width: 900px;"><div data-title="Importe" id="divIngresoImporte" style="display: block;">
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if(!puedeContratar){
			log('Cliente no dispone de cuentas corrientes, se inhibe el proceso de contratacion');
			$("#condicionFiltroTenencia #condicionTenenciaRequerida").removeClass('hidden').find('#descripcionMensaje').html(obtenerInformacionContratar());
		}

		$("#movimiento").on('keyup',function(ev) {
			if (ev.which === 13) {
				busquedaValida(true);
			}
		});
...
<script>
	...
	$(function(){
		...
		if(!puedeContratar){
			$("#contenedorInversionesDestacadas #condicionTenenciaRequerida").removeClass('hidden').find('#descripcionMensaje').html(obtenerInformacionContratar());
		}
		
		
		$("#inversionesDestacadas ul li").on('click',function(){	// Estoy parado en un LI

			if(!$(this).hasClass('active')){

				$(this).addClass('active');
				
				if(!$($(this).find('a').attr('href')).hasClass('active in')){
					$($(this).find('a').attr('href')).addClass('active in');				
				}

				$(this).siblings().removeClass('active');
				
				if($($(this).siblings().find('a').attr('href')).hasClass('active in')){
					$($(this).siblings().find('a').attr('href')).removeClass('active');				
					$($(this).siblings().find('a').attr('href')).removeClass('in');				
				}
				
				$(document).trigger('capgemini.ajax.load', $("#inversionesDestacadas"));
			}
