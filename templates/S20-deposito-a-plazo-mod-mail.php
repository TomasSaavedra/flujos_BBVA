	...
	<div class="content">
		...
		<body>
			<main class="formcontent"><!-- is-disabled-->
				...
				<section id="step_one" class="formcontent section_main text_font_form" style="display: none;">
				...
				<section id="step_two" class="formcontent section_main text_font_form" style="display: none;">
				...
				<section id="step_three" class="formcontent section_main heightSection4 text_font_form" style="display: none;">
			...
			<div class="solicitudEnviada" id="clienteBBVA" style="height: auto !important"><!-- Cliente BBVA -->
				<div class="row block_two_columns content_text modalSms" style="margin-bottom: 0px !important">
					<div class="small-12 medium-12 large-12 columns content">
						
						<h2 class="mgBottom20px" style="font-family: 'BBVA web Book', arial;">
							Estimado cliente, para poder tomar tu Depósito a Plazo, es necesario que modifiques tu Email de contacto.
						</h2>
						<div class="large-12 medium-12 small-12 columns contentSection">
							<h4 >Instrucciones para modificar tu Email de contacto:</h4>

							<div class="row contentItems">
								<div class="large-4 medium-4 small-12 columns items" >
									<img src="img/acceso-clientes.svg">
									<p >1. Accede a tu cuenta BBVA.</p>
								</div>
								<div class="large-4 medium-4 small-12 columns items">
									<img src="img/editar-perfil.svg">
									<p style="">2. Ingresa a "Editar mi perfil" y actualiza tu Email de contacto.</p>
								</div>
								<div class="large-4 medium-4 small-12 columns items">
									<img src="img/depositos.svg" style="width: 49px;">
									<p >3. Vuelve a simular y toma en línea tu DAP.</p>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-12 col-md-12 col-xs-12">
						<div class="row  mgTop20px mgBottom20px">
							<p class="text-center">También podrás realizar esta modificación en cualquiera de nuestras sucursales. <a href="" class="linkBottom">Ver sucursales BBVA</a></p>	
						</div>
					</div>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				$("#next_zero").click(function() {
					...
					$(".formcontent").hide();
					$("#clienteBBVA").fadeIn("fast");
					$('html,body').animate({
						scrollTop : $("#clienteBBVA").offset().top
					}, 'slow');
				});	
