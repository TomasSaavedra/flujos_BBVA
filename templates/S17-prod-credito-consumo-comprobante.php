...
<div class="container-bck clearfix">
	...
	<div class="exito-container-bck clearfix">
		...
		<ul class="detalle-list clearfix">
			...
			<li><span class="s-left">Monto solicitado:</span>		<span id="comprobanteMontoCredito">$ 9.000.000</span></li>
			...
			<li><span class="s-left">Fecha primera cuota: </span>	<span id="comprobanteFechaPrimeraCuota">02/06/2016</span></li>
			<li><span class="s-left">Seguro de Desgravamen: </span>		<span id="comprobanteSeguroDesgravamen">Sí</span></li>
			<li><span class="s-left">Polizas de Seguros: </span>		<span id="comprobanteSeguroCesantia"><a href="#"><i class="icon-16 blue l01-pdf"></i> Descargar</a></span></li>
			<li><span class="s-left">Seguro de Desgravamen: </span>			<span id="comprobanteSeguroVida"><a href="#"><i class="icon-16 blue l01-pdf"></i> Descargar</a></span></li>
		...
		<p>
			El comprobante y detalle de tu Crédito contratado <br> fue enviado a tu e-mail <span class="color-blue" id="comprobanteEmail">usuariocanales@gmail.com</span>
		</p> 
	</div>  	 
