<?php
	...
	if(isset($_REQUEST['src'])) {
		...
		if($_REQUEST['src'] == 'S02-posicion-global-dap.php'
				|| $_REQUEST['src'] == 'S02-posicion-global-dap.php'
		...
		if($_REQUEST['src'] == 'S02-cuentas-dap.php'
		...
		if($_REQUEST['src'] == 'S02-tarjetas-dap.php'
				|| $_REQUEST['src'] == 'S03-tarjetas.php'
				|| $_REQUEST['src'] == 'S03-tarjetas-debito.php') {
			$current = 'tarjetas';
		}
		if($_REQUEST['src'] == 'S07-creditos-dap.php'
		...
		if($_REQUEST['src'] == 'S18-ahorro-e-inversion-dap.php'
				...
				|| $_REQUEST['src'] == 'S09-deposito-a-plazo.php'
				|| $_REQUEST['src'] == 'S09-deposito-a-plazo-dap.php'
				|| $_REQUEST['src'] == 'S08-deposito-catalogo.php'
				) {
			$current = 'ahorro-inversion';
		}

		if($_REQUEST['src'] == 'S02-seguros-dap.php'
	...
	<body>
		...
		<?php
			...
			if($logged){
				...
				include 'includes/components/header-dap.php';
		...
		<?php
			if($logged){
				include 'includes/components/footer-dap.html';
			} else {
